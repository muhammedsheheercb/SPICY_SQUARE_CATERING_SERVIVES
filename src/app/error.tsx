...
const Error: React.FC<ErrorProps> = ({
  ...
  message = "We're experiencing some technical difficulties. Our team at Spicy Square Catering is working to fix this issue. Please try again in a moment.",
}) => {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mx-auto max-w-2xl rounded-2xl border-2 border-[#A9861B]/20 bg-white p-8 shadow-2xl">
          ...
          <p className="font-montserrat__alternates mb-6 text-sm text-[#666666]">
            Contact Spicy Square Catering directly for orders, inquiries, or
            support
          </p>
