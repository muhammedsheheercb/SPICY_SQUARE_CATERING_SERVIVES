...
const ReviewsSection = () => {
  ...
  const reviews: Review[] = [
    ...
    {
      rating: 5,
      text: "I've been ordering the 2-time food package for 3 months now. The quality is consistently excellent, portions are generous, and the taste is just perfect. The Friday biryani is absolutely phenomenal! Highly recommend Spicy Square Catering.",
