        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p>Spicy Square Catering - Authentic Indian Cuisine</p>
            </div>
...
---
Spicy Square Catering Services
...
Email: sq@spicysquare.in
    ...
    const customerMailOptions = {
      from: `${process.env.EMAIL_FROM_PREFIX || 'Spicy Square Catering'} <${process.env.EMAIL_USER}>`,
      to: email,
      subject: 'Thank You for Contacting Spicy Square Catering',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for contacting <strong>Spicy Square Catering</strong>! We've received your message and appreciate your interest in our authentic Indian cuisine.</p>
              ...
              <strong>The Spicy Square Catering Team</strong></p>
            </div>
...
Thank you for contacting Spicy Square Catering! We've received your message and appreciate your interest in our authentic Indian cuisine.
...
Warm regards,
The Spicy Square Catering Team

---
Spicy Square Catering Services
Authentic Indian Cuisine • Fresh Daily Preparation • Home Delivery
© ${new Date().getFullYear()} Spicy Square Catering. All Rights Reserved.
      `,
    };
